...
function test_rebuild_styles() {
    wp_enqueue_style( 'test-rebuild-style-includes',  get_template_directory_uri().'/assets/css/includes.css' );
    wp_enqueue_style( 'test-rebuild-style-assets',  get_template_directory_uri().'/assets/css/assets.css' );

}
add_action( 'wp_enqueue_scripts', 'test_rebuild_styles' );


function test_rebuild_scripts() {
	wp_enqueue_script( 'test-script-includes',  get_template_directory_uri().'/assets/js/includes.js', [], false, true );
	wp_enqueue_script( 'test-script-assets',  get_template_directory_uri().'/assets/js/assets.js', [], false, true );
}
add_action( 'wp_enqueue_scripts', 'test_rebuild_scripts' );
